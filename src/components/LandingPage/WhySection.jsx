      ...
      <div className={`max-page-width relative flex flex-col-reverse xl:flex-row justify-between xl:items-center md:gap-10 gap-8 md:p-8 p-4 `}>
        ...
        <div className="flex flex-col max-w-[600px]">
          <motion.h2
            ...
            className="xl:text-[38px] md:text-[26px] text-[20px] font-bold text-[#1A1A1A] leading-[1.1]"
          >
            Why Choose Chronox
          </motion.h2>
          <motion.p
            ...
            whileInView="show"
            viewport={{ once: true, amount: 0.7 }}
            className="mt-3 text-start text-[#636363] xl:text-[18px] lg:text-[16px] text-[14px] max-w-[600px]"
          >
