...
const TestimonialSection = () => {
  ...
  const testimonials = [
    {
      testimony: "Chronox has completely changed the game for me. I track my blood pressure on the go, and easily have access to a health coach.",
      userImage: User1,
      name: "Jacob Smith",
    ...
    {
      testimony: "With my tight schedule, Chronox helps me stay consistent. Everything — from my readings to consultations — is in one place.",
      userImage: User3,
      name: "Mary Jane",
      profession: "Student",
    },
