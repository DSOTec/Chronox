...
function UpcomingSessionCard({ date = "June 15,2025", time = "9:00am-10:00am", onFeedback }) {
  return (
    <div className="bg-white rounded-2xl p-8 flex flex-col items-center w-[380px] h-[40vh] shadow-md">
      ...
      <button
        className="bg-[#23D1B4] text-white text-xl font-semibold rounded-full px-14 py-4 focus:outline-none"
        onClick={onFeedback}
      >
        Give feedback
      </button>
