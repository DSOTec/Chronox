...
function FirstLine({ value, onChange, placeholder = "Search for health coach", onFilterClick }) {
  return (
    <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center w-full">
      ...
      <div className="firstline flex flex-col gap-3 w-full sm:flex-row sm:items-center sm:gap-4 max-w-3xl">
        {/* Search Bar */}
        <div className="input bg-white rounded-full flex items-center px-4 py-2 sm:px-6 sm:py-3 flex-1 shadow">
      ...
      <div className="date flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-6 w-full sm:w-auto justify-between">
