  ...
  return (
    <div className="bg-[#E8F2F1] min-h-screen">
      <div className="flex flex-col lg:flex-row items-start justify-between bg-[#F5F5F5] min-h-screen">
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mt-4">
                <div className="bg-white rounded-[20px] p-4 flex flex-col gap-2 w-full">
                  ...
                  <img src={heartprogress} alt="Heart Progress" />
                ...
                <div className="bg-white rounded-[20px] p-4 flex flex-col gap-2 w-full">
                  ...
                  <p className="text-sm text-gray-400">Past 7 days</p>
                  <img src={glucoselevel} alt="Glucose Level" />
        ...
        {/* Right Aside */}
        <aside className="bg-[#23ccb2] w-full lg:w-[25%] h-auto lg:h-[150vh] p-4 rounded-t-[10px] lg:rounded-r-[10px] lg:rounded-t-none shadow-lg mt-4 lg:mt-0">
          <div className="flex items-center gap-4">
            <img src="https://via.placeholder.com/150" alt="Placeholder" className="w-[50px] h-[50px] rounded-full" />
            <div>
              <h1 className="font-semibold text-white">Paul Dairo</h1>
              <p className="text-white">36 Years</p>
            </div>
          </div>
          <div className="mt-6">
            <h1 className="text-white font-semibold">My Conditions</h1>
            <button className="ml-2 px-3 py-1 bg-white text-[#23ccb2] rounded-full text-lg">+</button>
          </div>
          <div className="mt-4 flex flex-wrap gap-2">
            <button className="px-4 py-1 bg-white text-[#23ccb2] rounded-full">Diabetes</button>
            <button className="px-4 py-1 bg-white text-[#23ccb2] rounded-full">Hypertension</button>
            <img src={cancelicon} alt="Cancel Icon" className="w-[20px] h-[20px] cursor-pointer" />
          </div>
          <div className="mt-6 text-white font-semibold">Your Activity</div>
          <div>
          ...
          <div className="mt-6">
            <h2 className="text-white font-semibold">Appointment</h2>
          </div>
          <div>
            {/* Appointment Card */}
              ...
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-[#e8f2f1] rounded-[4px] flex items-center justify-center">
                  <svg width="28" height="28" fill="none" viewBox="0 0 24 24">
                    <rect width="20" height="16" x="2" y="5" fill="#23ccb2" rx="2" />
                    <rect width="16" height="10" x="4" y="9" fill="#fff" rx="1" />
                    <rect width="2" height="4" x="7" y="13" fill="#23ccb2" rx="1" />
                    <rect width="2" height="4" x="11" y="13" fill="#23ccb2" rx="1" />
                    <rect width="2" height="4" x="15" y="13" fill="#23ccb2" rx="1" />
                  </svg>
                </div>
                <div>
                  <div className="font-semibold text-[#373737] text-lg">Dr. Mark Odoma</div>
                  <div className="text-[#4F46E5] text-base">Health Coach</div>
                </div>
              </div>
              <div className="flex flex-col items-end gap-2 mt-2 sm:mt-0">
                <span className="text-gray-400 text-base">Today</span>
                <div className="flex items-center gap-1">
                  <span className="w-4 h-4 bg-[#23ccb2] rounded-full flex items-center justify-center">
                  ...
                  <span className="text-[#636363] text-base font-medium ml-1">11:00AM</span>
                </div>
              </div>
            </div>
            {/* Apple Health Card */}
            <div className="bg-white rounded-[20px] p-6 flex flex-col gap-4 w-full mt-4">
              <div className="flex flex-col sm:flex-row justify-between items-start">
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-[#e8f2f1] rounded-[4px] flex items-center justify-center">
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                      <path d="M19.665 12.837c-.02-2.14 1.75-3.163 1.83-3.213-1-1.46-2.56-1.66-3.11-1.68-1.32-.13-2.58.77-3.25.77-.67 0-1.7-.75-2.8-.73-1.44.02-2.77.84-3.51 2.13-1.5 2.6-.39 6.44 1.07 8.55.71 1.03 1.56 2.19 2.67 2.15 1.08-.04 1.49-.69 2.8-.69 1.31 0 1.68.69 2.8.67 1.16-.02 1.89-1.04 2.59-2.07.82-1.19 1.16-2.34 1.18-2.4-.03-.01-2.26-.87-2.28-3.45zm-2.68-6.31c.6-.73 1-1.75.89-2.77-.86.03-1.89.57-2.5 1.3-.55.64-1.04 1.67-.85 2.65.9.07 1.86-.46 2.46-1.18z" fill="#23ccb2" />
                    </svg>
                  </div>
                  <div>
                    <div className="font-semibold text-[#4F46E5] text-lg">Apple Health</div>
                    <div className="text-[#373737] text-base">Last synced</div>
                    <div className="text-[#373737] text-base">Status</div>
                  </div>
                </div>
                <div className="flex flex-col items-end gap-2 mt-2 sm:mt-0">
                  <span className="text-gray-400 text-base">Today at 6:15AM</span>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[#23ccb2] text-base font-medium">Synced successfully</span>
                  </div>
                </div>
              </div>
              <button className="mt-2 bg-[#23ccb2] hover:bg-[#1bb39e] transition-colors text-white font-semibold text-xl rounded-lg px-8 py-2 flex items-center gap-2 self-start">
                Refresh
            ...
            {/* Hydration Card */}
            <div className="bg-white rounded-[30px] p-6 flex flex-col gap-4 w-full mt-4">
              <img
              ...
              />
              <div className="mt-2 font-semibold text-[#4F46E5] text-2xl leading-snug">
                Why staying hydrated is Important<br />for your health
              </div>
